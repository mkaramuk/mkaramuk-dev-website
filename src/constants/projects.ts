export const projects = [
	...
	},
	{
		...
		about: "Rika is an open-source project management application built on top of the Nest.js backend framework and PostgreSQL as database. It utilizes React.js and TailwindCSS for the frontend stack. The application provides features similar to Jira and Trello, allowing users to manage tasks and projects.",
		href: "https://github.com/rika-hq",
	},
	{
		name: "Konstruct",
		summary: "Kubernetes cluster provisioner on GCP",
		about: "Konstruct is a collection of Ansible, Terraform, and Bash Scripts designed to provision a Kubernetes cluster on Google Cloud Platform using Compute Engine.",
